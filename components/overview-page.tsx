...
export function OverviewPage({ data }: { data: OverviewData }) {
  return (
    <AdminPage>
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end"><PageIntro eyebrow="Platform pulse" title="What needs your attention?" description="A server-rendered view of the people, trust signals, and content shaping GemFort today." /><Link href="/" className="inline-flex h-9 items-center justify-center rounded-4xl border border-border bg-background px-3 text-sm font-medium transition-colors hover:bg-muted">Refresh data</Link></div>
